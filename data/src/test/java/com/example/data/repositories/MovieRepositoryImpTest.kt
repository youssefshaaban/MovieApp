...
import com.example.data.mapper.MoviePageDataMapper
...
//    @Before
//    fun setUp() {
//        movieRepositoryImp = MovieRepositoryImp(movieAPI,networkChecker,batteryChecker, dataMapper)
//    }
//
//    @After
//    fun tearDown() {
...
//        // Mock API response
//        val mockResponse = TestUtil.createMockGetMovieResponse()
